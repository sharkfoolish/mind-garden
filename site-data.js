...
const PRODUCTS = [
  // 植栽
  { id: "p1", cat: "plant", catName: "植栽", icon: "🪴", name: "多肉植物療癒組合包", desc: "5 款入門款多肉，附陶盆與培養土。", price: 680 },
  { id: "p2", cat: "plant", catName: "植栽", icon: "🌵", name: "仙人掌療癒系列", desc: "金琥、月世界等 3 入耐旱組合。", price: 520 },
  { id: "p3", cat: "plant", catName: "植栽", icon: "🌿", name: "觀葉植物大師組", desc: "龜背芋、琴葉榕、蔓綠絨三選一。", price: 1200 },
  { id: "p4", cat: "plant", catName: "植栽", icon: "🌱", name: "苔蘚生態瓶 DIY", desc: "玻璃瓶 + 山苔 + 造景組件全套。", price: 880 },
  // 花藝
  { id: "p5", cat: "flower", catName: "花藝", icon: "🌷", name: "四季花藝材料包", desc: "當季鮮花搭配，每月主題不同。", price: 890 },
  { id: "p6", cat: "flower", catName: "花藝", icon: "🌺", name: "乾燥花束 DIY 組", desc: "永生玫瑰 × 滿天星，自由組合。", price: 760 },
  { id: "p7", cat: "flower", catName: "花藝", icon: "💐", name: "療癒手綁花週禮盒", desc: "每週新鮮花束直送到府。", price: 1280 },
  // 文具
  { id: "p8", cat: "stationery", catName: "文具", icon: "📓", name: "每日情緒日記本", desc: "120 天情緒追蹤頁，引導式書寫。", price: 420 },
  { id: "p9", cat: "stationery", catName: "文具", icon: "✏️", name: "感恩植物書寫卡組", desc: "30 張植物水彩感恩練習卡。", price: 280 },
  { id: "p10", cat: "stationery", catName: "文具", icon: "📒", name: "正念冥想引導本", desc: "8 週正念練習工作手帳。", price: 520 },
  // 香氛
  { id: "p11", cat: "scent", catName: "香氛", icon: "🕯️", name: "森林香氛蠟燭", desc: "雪松與青苔，180g 大豆蠟。", price: 580 },
  { id: "p12", cat: "scent", catName: "香氛", icon: "🧴", name: "薰衣草助眠精油", desc: "10ml 法國普羅旺斯有機認證。", price: 520 },
  { id: "p13", cat: "scent", catName: "香氛", icon: "🌸", name: "玫瑰療癒香氛噴霧", desc: "100ml 居家氣場淨化專用。", price: 680 },
  { id: "p14", cat: "scent", catName: "香氛", icon: "🌿", name: "尤加利擴香組", desc: "藤條擴香瓶 200ml，香氣 60 天。", price: 780 },
  // 工具
  { id: "p15", cat: "tool", catName: "工具", icon: "🛠️", name: "居家園藝工具五件組", desc: "鏟、剪、耙、噴瓶、手套全套。", price: 980 },
  { id: "p16", cat: "tool", catName: "工具", icon: "🪴", name: "陶土植栽盆 3 件組", desc: "S/M/L 三尺寸天然陶盆。", price: 640 },
  { id: "p17", cat: "tool", catName: "工具", icon: "💧", name: "智慧灑水計時器", desc: "出差不擔心，自動定時澆灌。", price: 1480 },
];
